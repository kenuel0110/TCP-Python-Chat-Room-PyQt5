...
class Ui_DialogConnectTo(object):
    def setupUi(self, DialogConnectTo):
        ...
        self.verticalLayout.setContentsMargins(8, 6, 9, 0)
        ...
        self.pushButtonSave.setMaximumSize(QtCore.QSize(16777215, 46))
        self.pushButtonSave.setSizeIncrement(QtCore.QSize(0, 46))
        self.pushButtonSave.setBaseSize(QtCore.QSize(0, 46))
        self.pushButtonSave.setFont(font)
        self.pushButtonSave.setStyleSheet("QPushButton:!hover {background-color: rgb(61, 40, 0); text-align: center; border-style: outset; border-width: 0px;}\n"
"QPushButton:hover {background-color: rgb(88, 58, 0); text-align: center; border-style: outset; border-width: 0px;}")
        ...
        self.pushButtonExit.setMinimumSize(QtCore.QSize(0, 46))
        self.pushButtonExit.setMaximumSize(QtCore.QSize(16777215, 46))
        self.pushButtonExit.setSizeIncrement(QtCore.QSize(0, 46))
        self.pushButtonExit.setBaseSize(QtCore.QSize(0, 46))

        self.pushButtonExit.setFont(font)
        self.pushButtonExit.setStyleSheet("QPushButton:!hover {background-color: rgb(61, 40, 0); text-align: center; border-style: outset; border-width: 0px;}\n"
"QPushButton:hover {background-color: rgb(88, 58, 0); text-align: center; border-style: outset; border-width: 0px;}")
