...
class Ui_DialogErrorInputSymbols(object):
...
"QPushButton:pressed {background-color: #382500;color: White;border-style: outset;border-width: 2px;border-radius: 15px;border-color: #241800;padding: 4px;}")
    ...
    def retranslateUi(self, DialogErrorInput):
        ...
        self.labeltext.setText(_translate("DialogErrorInput", "<html><head/><body><p>Убедитесь, что не используете не поддерживаемые символы:</p><center><p>!@#№'$%^&*⟩⟨-=+(]}_{[):;.,~`/\</p></center></body></html>"))
